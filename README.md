...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/introspection-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/introspection-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add introspection
# for installing globally
pixi global install introspection
```
...
It is possible to list all of the versions of `introspection` available on your platform:
...
```
pixi search introspection --channel conda-forge
```
